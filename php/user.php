...
<body>
        ...
        <div class="icons">
            <a href="" onclick="dropDown()" class="dropbtn"><i class="fa fa-user"></i>Login</a>
                    <div id="myDropDown" class="dropdown-content">
                        ...
                        <a href="" class="create-account"><i class="fa fa-user"></i>CREATE ACCOUNT</a>
    ...
    <div class="register-login">
        ...
        <div class="register">
            ...
            <p>
                Craete your account in just a  few clicks! Use either your e-mail address or Facebook account.

            </p>
            <a href=""><i class="fa fa-envelope-o"></i>CREATE ACCOUNT VIA E-MAIL</a>
            <a href=""><i class="fa fa-facebook-official"></i>REGISTER WITH FACEBOOK</a>
        </div>
